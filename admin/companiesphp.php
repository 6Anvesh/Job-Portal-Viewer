...
<input type='date'  id='com_drive' value='$row[com_drive_date]' class='form-control' required>
</div>
<div class='form-group'>
<label>Last Date of Registration</label>
<input type='date' id='com_reg_date' value='$row[com_reg_date]' class='form-control' required>
</div>
<div class='form-group'>
